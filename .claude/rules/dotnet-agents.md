...
- **DO** route to specialist agents for domain-specific work. Check DOTNET-AGENTS.md for the routing table. Agent definitions live at `dotnet-agents/<agent-name>.md`.
...
- **DO** load relevant skills before starting work. Check DOTNET-AGENTS.md skill maps for the current task domain. Skills referenced by agents live at `dotnet-skills/<skill-name>/SKILL.md`.
