...
|-------|------|---------------|
| dotnet-architect | `dotnet-agents/dotnet-architect.md` | Architecture, project structure, module boundaries |
| api-designer | `dotnet-agents/api-designer.md` | Minimal APIs, OpenAPI, versioning, rate limiting |
| ef-core-specialist | `dotnet-agents/ef-core-specialist.md` | Database, queries, migrations, EF Core patterns |
| test-engineer | `dotnet-agents/test-engineer.md` | Test strategy, xUnit, WebApplicationFactory, Testcontainers |
| security-auditor | `dotnet-agents/security-auditor.md` | Authentication, authorization, OWASP, secrets |
| performance-analyst | `dotnet-agents/performance-analyst.md` | Benchmarks, memory, async patterns, caching |
| devops-engineer | `dotnet-agents/devops-engineer.md` | Docker, CI/CD, Aspire, deployment |
| code-reviewer | `dotnet-agents/code-reviewer.md` | Multi-dimensional code review |
| build-error-resolver | `dotnet-agents/build-error-resolver.md` | Autonomous build error fixing |
| refactor-cleaner | `dotnet-agents/refactor-cleaner.md` | Systematic dead code removal and cleanup |
...
These 6 meta and productivity skills are not tied to a specific agent — any agent can load them when the context calls for it:
